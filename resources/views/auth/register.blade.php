    ...
    <div class="box">
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                {!! Form::control('email', 6, 'email', $errors, trans('front/register.email',['id'=>'email'])) !!}
            </div>
            <div class="row">	
            ...
            <div class="row">
                {!! Form::label('text', trans('front/register.role'), ['class'=>'col-lg-12'])!!}
            </div>
            <div>
                {!! Form::select('role', array('use'=>'Service user','pro'=>'Service provider'),'default',['id'=>'role'])!!}
            </div>
    ...
    $(function () {
        ...
        $(document).ready(function () {
            $("#role").change(function () {
                console.log('change');
                if ($('#role').val() == 'pro')
                    $("#email").attr('placeholder','Please provide email of your PayPal business account');
                else
